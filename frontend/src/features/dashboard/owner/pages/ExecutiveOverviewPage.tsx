...
export const ExecutiveOverviewPage = () => {
  ...
  return <div className="page-container space-y-6">
    <div><p className="text-sm font-medium text-primary">{t("executiveOverviewPage.executive_overview")}</p><h1 className="text-3xl font-bold">{t("executiveOverviewPage.assigned_project_portfolio")}</h1><p className="mt-1 text-muted-foreground">A concise cross-project summary separate from the project dashboard.</p></div>
