  ...
  return (
    <div className="page-container space-y-6">
      ...
      <Card className="grid gap-3 p-4 md:grid-cols-6">
        ...
        <Select value={filterStatus} onChange={e=>setFilterStatus(e.target.value)} options={[{value:"",label:"All statuses"},...['proposed','under_review','approved','rejected','implemented'].map(value=>({value,label:value.replace('_',' ')}))]}/>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Badge size="sm">{change.sourceDiscipline}</Badge>
